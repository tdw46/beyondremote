...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Beyond Remote network..."),
        ("not_ready_status", "Not ready. Please check your connection"),
        ("ID/Relay Server", "Self-hosted ID/Relay server"),
        ...
        ("ID Server", "Self-hosted ID server"),
        ("Relay Server", "Self-hosted relay server"),
        ("API Server", "Self-hosted API server"),
        ...
        ("install_tip", "Due to UAC, Beyond Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Beyond Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Beyond Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Beyond Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Beyond Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Beyond Remote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Beyond Remote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Beyond Remote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Beyond Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Beyond Remote."),
        ...
        ("verify_rustdesk_password_tip", "Verify Beyond Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Beyond Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "The configured server must support version {} or newer for this feature."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Beyond Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Beyond Remote"),
        ...
        ("ab_web_console_tip", "Open server web console"),
        ("allow-only-conn-window-open-tip", "Only allow connection if Beyond Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep Beyond Remote background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Beyond Remote client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Beyond Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, Beyond Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Beyond Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "This option depends on support in your configured self-hosted server."),
